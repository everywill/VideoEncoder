...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_h264_write')) {
        Object.defineProperty(Module['ready'], '_h264_write', { configurable: true, get: function() { abort('You are getting _h264_write on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_h264_write', { configurable: true, set: function() { abort('You are setting _h264_write on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'x264.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('x264.wasm', import.meta.url).toString();
}
...
var ASM_CONSTS = {
  ...
  /** @type {function(...*):?} */
  function _h264_write_polyfill(
  ) {
  err('missing function: h264_write_polyfill'); abort(-1);
  }
...
var asmLibraryArg = {
  ...
  "fd_seek": _fd_seek,
  "fd_write": _fd_write,
  "h264_write_polyfill": _h264_write_polyfill,
...
/** @type {function(...*):?} */
var _h264_write = Module["_h264_write"] = createExportWrapper("h264_write");
